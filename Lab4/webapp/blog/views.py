...
from blog.async_requests import get_ordered_posts, get_all_categories, get_posts_by_category, get_authors_blog  # async
...
class BlogListView(ListView):
    ...
    queryset = asyncio.run(get_ordered_posts('-time_create'))
...
class MyPostsList(ListView):
    ...
    def get_queryset(self):
        coroutine = get_authors_blog(self.request.user.pk)
        return asyncio.run(coroutine)
